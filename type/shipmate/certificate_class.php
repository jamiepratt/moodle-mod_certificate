...
class shipmate_cert_main {
    public function __construct() {
        ...
        $orientation = "L";
        $pdf->Image("$CFG->dirroot/mod/certificate/pix/borders/shipmate2.jpg", 10, 12);
        ...
        print_signature($certificate->printsignature, $orientation, 320, 430, '', '');
        
        $pdf->SetLineWidth(1);
        $pdf->Line(320, 483, 460, 483); //sigsize 140 * 63
        cert_printtext(320, 493, 'L', 'FreeSerif', 'B', 10, 'Training Developer Signature');
    
        $pdf->Line(130, 483, 270, 483);
        cert_printtext(130, 493, 'L', 'FreeSerif', 'B', 10, 'Employer Signature');
    	...
    	cert_printtext(145, 230, 'C', 'FreeSerif', 'I', 20, 'presented to');
        cert_printtext(145, 260, 'C', 'FreeSerif', 'B', 30, $studentname);
        
        $timeformat = get_string('strftimedaydate');
        $certificatedate = userdate($certrecord->certdate, $timeformat);
        
        
        cert_printtext(145, 310, 'C', 'FreeSerif', 'B', 20, $certificatedate);
        
        cert_printtext(145, 340, 'C', 'FreeSerif', 'B', 20, $this->expiry_date($certrecord->certdate, $timeformat));
        
        cert_printtext(145, 370, 'C', 'FreeSerif', 'B', 20, 'Score : '.$coursegrade);
        cert_printtext(145, 545, 'C', 'FreeSerif', '', 12, "Verification code :".$code);
    
        cert_printtext(150, 515, 'C', 'FreeSerif', 'I', 10, $customtext);
    }
